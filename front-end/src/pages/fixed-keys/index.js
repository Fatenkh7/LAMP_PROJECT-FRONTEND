    ...
    <div className="fixedkeys-container">
      ...
      >
        <div className="add-fixedkeys">
          <MainButton name="Add FixedKey" onClick={() => setAddPop(true)} />
        </div>
      ...
      {addPop && (
        <Popup close={closePop}>
          <div
            className="fixedkeys-close-popup"
            onClick={() => {
              setAddPop(false);
            }}
          >
          ...
          >
            ...
            <form className="pop-up-form">
              <TextField id="outlined-controlled" label="Add Fixed Keys" />
